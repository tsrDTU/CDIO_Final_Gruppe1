...
//            file = new File("src/main/Language/German");
    ...
    if (sprog=="Dansk") {
        ...
        dialog[2] = "Vælg spillerens rolle";
...
/*
            ...
            dialog[2] = "Sélectionner le rôle du joueur";
            ...
            dialog[2] = "Select the role of the player";
            ...
            dialog[2] = "Wählem Sie die Rolle des Spielers aus";
