...
public class MGUI
{
     ...
     */
        ...
        private MGUI_BoardController boardController;
        ...
        */
         ...
         * Works as if you had called {@link gui_main.GUI#setChanceCard(String)} and {@link gui_main.GUI#displayChanceCard()}.
         *
         ...
         * {@link gui_main.GUI#displayChanceCard()}, or the center square is clicked.
         * Note that the text is NOT displayed automatically when calling this method (instead
         * use the {@link gui_main.GUI#displayChanceCard(String)} method).
         *
         * @param txt : The chance card text to be displayed (mind the length)
         */
         ...
         * {@link gui_main.GUI#setChanceCard(String)} method.
         */
