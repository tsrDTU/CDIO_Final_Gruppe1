    ...
    public Chance()
{
    ...
    chanceCards[5]=new ChanceOverdragelseskort("Til Skibet","Giv dette kort til SkibetSpiller1Spiller1 og tag et chancekort mere. Skib: På den næste skal du sejle frem til hvilket som helst ledigt felt og købe det. Hvis der ikke er nogen ledige felter, skal du købe et af en anden spiller.","SkibetSpiller1");
    ...
    chanceCards[11]=new ChanceOverdragelseskort("Til KattenSpiller2","Giv dette kort til KattenSpiller2 og tag et chancekort mere. Kat: På den næste skal du sejle frem til hvilket som helst ledigt felt og købe det. Hvis der ikke er nogen ledige felter, skal du købe et af en anden spiller.","KattenSpiller2");
    chanceCards[12]=new ChanceOverdragelseskort("Til HundenSpiller3","Giv dette kort til HundenSpiller3 og tag et chancekort mere. Hund: På den næste skal du sejle frem til hvilket som helst ledigt felt og købe det. Hvis der ikke er nogen ledige felter, skal du købe et af en anden spiller.","HundenSpiller3");
